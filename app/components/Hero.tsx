        ...
        <section className="relative overflow-hidden">
            ...
            <LayoutWrapper className="grid grid-cols-1 lg:grid-cols-2 py-18 lg:py-24">
                <div className="space-y-4">
                    ...
                    <p className="text-[16px] md:text-[18px] text-slate-500">Reverz Cloud คือโฮสติ้งที่ตั้งค่าง่าย ใช้งานคล่อง มี SSL ฟรี สำรองข้อมูลรายวัน และทีมช่วยเหลือ 24/7 — เหมาะทั้งเว็บส่วนตัว ร้านค้า และองค์กร</p>
